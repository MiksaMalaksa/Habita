              ...
              children: [
                ...
                Center(
                    child: HabitaDropDown<String>(
                        ...
                        initialValue: context.read<ThemeBloc>().state.combName,
                        onChoosed: (String scheme) {
                          context
                              .read<ThemeBloc>()
                              .add(ThemeChangeComb(comb: scheme));
                          sl.get<SharedPreferencesUtils>().addThemeComb(scheme);
                        })),
                const SizedBox(height: 5),
                //*internationalization
                Center(
                    child: HabitaDropDown<Locale>(
                        initialValue: Habita.of(context)!.currentLocale!,
                        ...
                        onChoosed: (String locale) {
                          ...
                          sl.get<SharedPreferencesUtils>().addLang(locale);
                        })),
                //*Additianal settings
                const SizedBox(height: 20),
                Padding(
                  padding: const EdgeInsetsDirectional.only(start: 8),
                  child:
                      Text(S.of(context).additionalSettings, style: textTheme),
                ),
